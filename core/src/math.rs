...
mod tests {
    ...
    fn vec3_to_vec2_test() {
        assert_eq!(Vector2::<i32>::new(1, 2), vec3_to_vec2(Vector3::<i32>::new(1, 2, 3)));
    }

    #[test]
    fn vec2_to_vec3_test() {
        assert_eq!(Vector3::<i32>::new(1, 2, 3), vec2_to_vec3(Vector2::<i32>::new(1, 2), 3));
    }
}